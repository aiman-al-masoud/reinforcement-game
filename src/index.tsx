...
import { Biden, Canvas, Hamburger, IceCream, Keyboard, MonteCarlo, NoOp, Policy, Sombrero, Sprite, Stickman, Trump, Wall, World } from "./core";


function launchInteractiveGameplay() {
    ...
    let world = new World()
        ...
        .putSprite(Wall.create({ id: 'wall2', rows: 2, cols: 10, pos: v(100, 100) }))
        .putSprite(new Biden({ id: 'enemy', pos: v(150, 200) }))
        .putSprite(new IceCream({ id: 'icecream1', pos: v(40, 240), movable: false }))
...
function trainMonteCarloAndSimulateEpisode() {

    // example of simulating an episode with a policy and playing it back
...
// trainMonteCarloAndSimulateEpisode()
launchInteractiveGameplay()
